...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            ...
            <label class="float-right"> <i class="fas fa-user-check"></i> </label>
        </div>
        <div class="card-body">
            <table class="table table-striped" id="t_candidatos">
                ...
                @foreach($candidatos as $candidato)
                    <tr>
                        ...
                        <td>
                            <a href="/candidatos/desconsiderar/{{$candidato->id}}" title="Desconsiderar"> <i class="far fa-thumbs-down text-red"></i> </a>
                        </td>
                    </tr>
                @endforeach
                </tbody>

...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <span>Candidatos Disponíveis</span>
            <label class="float-right"> <i class="fas fa-user-tie"></i> </label>
        </div>
        <div class="card-body">
                ...
                @foreach($candidatos as $candidato)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="/candidatos/priorizar/{{$candidato->id}}" title="Desconsiderar"> <i class="far fa-thumbs-down text-red"></i> </a>
                        </td>
                    </tr>
                @endforeach
                </tbody>
